...
int32_t SaveClient::save_data(const SaveInfo& msg)
{
  send_save_data(msg);
  return recv_save_data();
}

void SaveClient::send_save_data(const SaveInfo& msg)
{
  int32_t cseqid = 0;
...
void SaveProcessor::process_save_data(int32_t seqid, ::apache::thrift::protocol::TProtocol* iprot, ::apache::thrift::protocol::TProtocol* oprot, void* callContext)
{
  ...
  try {
    result.success = iface_->save_data(args.msg);
...
int32_t SaveConcurrentClient::save_data(const SaveInfo& msg)
{
  int32_t seqid = send_save_data(msg);
  return recv_save_data(seqid);
}

int32_t SaveConcurrentClient::send_save_data(const SaveInfo& msg)
{
